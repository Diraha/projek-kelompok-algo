...
class DoubleLinkedList: #Class untuk menjalankan fitur CRUD(Create, Read, Update, Delete)
    ...
    def update_photo(self, old_nama:str, new_nama:str):
        ...
        while temp:
            ...
            if temp.data["nama_file"] == old_nama:
                ...
                self.save_to_file()
                print(f"Foto '{old_nama}' berhasil diubah menjadi '{new_nama}'!")
                return
    ...
    def display(self):
        ...
        print("\n[A]: Add Photo                                                       [T]: Trash History                                                       [R]: Sorting")
        print("[E]: Edit Photo                                                      [S]: Display Data Structure                                              [C]: Searching")
        print("[D]: Delete Photo                                                    [G]: Display GUI                                                         [X]: Exit\n")
